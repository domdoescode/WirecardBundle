            ...
            ->children()
                ...
                ->arrayNode('payment')
                    ...
                    ->children()
                        ...
                        //     ->cannotBeEmpty()
                        //     ->defaultValue('DomUdall\WirecardBundle\Entity\PaymentRequest')
                        //     ->end()
                        ->scalarNode('response_class')
                            ->cannotBeEmpty()
                            ->defaultValue('DomUdall\WirecardBundle\Entity\PaymentResponse')
                            ->end()
                ...
                ->arrayNode('qpay')
                    ...
                    ->children()
                        ...
                        ->scalarNode('fingerprint_order')
                            ->defaultValue('secret,customerId,amount,currency,language,successURL')
                            ->cannotBeEmpty()
                            ->end()
                        ->arrayNode('url')
                            ->addDefaultsIfNotSet()
